...
\begin{itemize}
	...
	\item {\bf Tech stack:} Go, Rust, Haskell, Python, Linux.

	\item {\bf CS fields:} distributed systems, concurrent programming, data structures, optimization, queuing theory, numerical models and simulations.

	\item {\bf Strengths} problem solver, create production-grade, high-performance and resilient solutions for the hard problems. Passionate about exploring ideas and converting research into working stuff.
