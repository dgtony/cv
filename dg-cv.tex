...
\begin{itemize}
	...
	\item {\bf Skills and interests:} distributed systems, networks, protocols, P2P, low-level concurrent programming, data structures, optimization, queuing theory, numerical models and simulations.

	\item {\bf Strengths:} problem solver, creating high-performance resilient production-grade solutions for the hard problems. Passionate about exploring ideas and converting research into working stuff.
